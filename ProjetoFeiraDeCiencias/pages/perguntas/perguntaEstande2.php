...
try {
    ...
    $stmt_check->bind_param("ii", $id_usuario, $id_materia_estande2);
    $stmt_check->execute();
    ...
    $stmt_check_avaliacao->bind_param("ii", $id_materia_estande2, $id_usuario);
...
if (!$quiz_ja_respondido && empty($erro)) {
    try {
        ...
        $stmt_question->bind_param("i", $id_materia_estande2);
        ...
        if ($result->num_rows > 0) {
            ...
            $erro = "Nenhuma pergunta encontrada para o Estande 2.";
        }
        $db->close();
    } catch (Exception $e) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !$quiz_ja_respondido) {
    ...
    if (empty($resposta_usuario) || empty($id_pergunta)) {
        ...
        header("location: perguntaEstande2.php");
        exit;
    }
    ...
    try {
        ...
        $finalizada = 1;
        $validada = $acertou;
        $stmt_tentativa->bind_param("iiiiii", $id_usuario, $id_materia_estande2, $acertos_iniciais, $total_perguntas, $finalizada, $validada);
        ...
        <div class="container">
            <section class="question-form">
                ...
                <?php elseif ($quiz_ja_respondido): ?>
                    ...
                    <a href="avaliacao.php?id_materia=<?php echo htmlspecialchars($id_materia_estande2); ?>" class="btn-voltar">Avaliar Estande</a>
                ...
                <?php elseif ($pergunta): ?>
                    <form action="perguntaEstande2.php" method="post">
